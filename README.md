...
Gestionador.py -> Página principal/home de la aplicación. En ella se define la navegación entre el resto de páginas.
...
README.md -> Archivo de informe del proyecto.
